...
All 3 tests pass: blob storage, deduplication, integrity check.
...
Both tests pass: serialize/parse roundtrip, deterministic serialization.
...
Shows staged files after `./pes add file1.txt file2.txt`.
...
**4A — pes log output:**
Shows full commit chain with hashes, author `Avyukt Ranjan <avyukt.ranjan@gmail.com>`, timestamps and messages.
